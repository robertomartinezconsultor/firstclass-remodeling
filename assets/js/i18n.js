...
const FCR_DICT = {
  ...
  'why.3.h':           { en: 'Real Reviews',        es: 'Reseñas reales' },
  'why.3.p':           { en: 'See our actual reviews on Google &mdash; unedited, straight from the source.',
                         es: 'Mira nuestras reseñas reales en Google &mdash; sin editar, directo de la fuente.' },
  ...
  'prj.stat.3':        { en: 'See real reviews',      es: 'Ver reseñas reales' },
  'reviews.heading':   { en: "Don't take our word for it.<br>Read it straight from the source.",
                         es: 'No te quedes solo con nuestra palabra.<br>Léelo directo de la fuente.' },
  'reviews.lead':      { en: "We're not going to put quotes on our own website and ask you to trust they're real. See the actual reviews, unedited, on the platforms where homeowners left them.",
                         es: 'No vamos a poner citas en nuestro propio sitio y pedirte que confíes en que son reales. Mira las reseñas reales, sin editar, en las plataformas donde los clientes las dejaron.' },
  'reviews.google':    { en: 'Google Reviews',        es: 'Reseñas de Google' },
  'reviews.googleSub': { en: 'See our real, verified reviews on Google →', es: 'Mira nuestras reseñas reales y verificadas en Google →' },
  'reviews.fb':        { en: 'Facebook Reviews',      es: 'Reseñas de Facebook' },
  'reviews.fbSub':     { en: 'See our real, verified reviews on Facebook →', es: 'Mira nuestras reseñas reales y verificadas en Facebook →' },
